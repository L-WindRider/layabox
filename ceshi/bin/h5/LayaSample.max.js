...
(function(window,document,Laya){
	...
	*/
	...
	var LayaSample=(function(){
		function LayaSample(){
			...
			var resArray=[{url:"res/atlas/comp.atlas",type:"atlas"}];
	...
	*/
	...
	//class ui.listOnclickUI extends laya.ui.Dialog
	var listOnclickUI=(function(_super){
		function listOnclickUI(){
			this.list=null;
			listOnclickUI.__super.call(this);
		}

		__class(listOnclickUI,'ui.listOnclickUI',_super);
		var __proto=listOnclickUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(listOnclickUI.uiView);
		}

		listOnclickUI.uiView={"type":"Dialog","props":{"width":600,"height":600},"child":[{"type":"Image","props":{"y":0,"x":0,"width":600,"skin":"comp/bg.png","height":600}},{"type":"List","props":{"y":431,"x":6,"width":586,"var":"list","spaceY":0,"spaceX":20,"height":79},"child":[{"type":"Image","props":{"y":0,"x":0,"skin":"comp/bg.png","name":"render"}}]}]};
		return listOnclickUI;
	})(Dialog)
	...
	*@author heheda
	*/
	//class view.listOnclickView extends ui.listOnclickUI
	var listOnclickView=(function(_super){
		function listOnclickView(){
			this.dataArr=[1,2,3,4,5,6];
			listOnclickView.__super.call(this);
			this.list.hScrollBarSkin="";
			this.list.selectEnable=true;
			this.list.scrollBar.elasticBackTime=150;
			this.list.scrollBar.elasticDistance=200;
			this.list.mouseHandler=Handler.create(this,this.onRender,null,false);
			this.list.array=this.dataArr;
		}

		__class(listOnclickView,'view.listOnclickView',_super);
		var __proto=listOnclickView.prototype;
		__proto.onRender=function(e,index){
			if(e.type=="click"){
				console.log(index,"click");
			}
		}

		return listOnclickView;
	})(listOnclickUI)
