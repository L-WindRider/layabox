...
(function(window,document,Laya){
	...
	*/
	...
	Laya.__init([Browser,LoaderManager,EventDispatcher,DrawText,Render,WebGLContext2D,ShaderCompile,Timer,LocalStorage,AtlasGrid]);
	new LayaSample();
