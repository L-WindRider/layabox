...
var DomButtonView=(function(_super){
	function DomButtonView(){
		...
		var _$this=this;
		console.log(this.imgBox._childs);
		this.timerOnce(3000,this,function(){
			_$this.qwe.x=200;
		})
		DomEvent.domEvent(this.qwe,DomEvent.clipboard,"gfgdghd");
		this.btnDel.on("click",this,function(){
			DomEvent.deleteButton(_$this.qwe);
		})
		this.btn.on("click",this,function(){
			DomEvent.domEvent(_$this.qwe,DomEvent.clipboard,"fgdsgdfgdf");
