...
//class ui.indexUI extends laya.ui.View
var indexUI=(function(_super){
	...
	__class(indexUI,'ui.indexUI',_super);
	var __proto=indexUI.prototype;
	__proto.createChildren=function(){
...
*@author heheda
*/
//class view.indexView extends ui.indexUI
var indexView=(function(_super){
	function indexView(){
		this.i=0;
		indexView.__super.call(this);
		var _$this=this;
		this.img.pivotX=this.img.left=this.img.width/2;
		this.img.pivotY=this.img.top=this.img.height/2;
		this.time.on("input",this,function(){
			_$this.timerLoop(parseFloat(_$this.time.text)||100,this,_$this.onTimer);
		});
		this.color.on("input",this,function(){
			_$this._bgColor.graphics.drawRect(0,0,Browser.clientWidth-400,Browser.clientHeight,_$this.color.text||"#FFFFFF");
		})
	}

	__class(indexView,'view.indexView',_super);
